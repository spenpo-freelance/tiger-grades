...
class EnrollClassShortcode {
    ...
    public function render($atts) {
        ...
        if ($user_id) {
            ...
            $form_title_text = $enrollment_code ? 'Enroll in ' . $class_teacher . '\'s ' . $class_title . ' class' : 'Enroll in a class';
            ...
            $submit_container = DOMHelper::createElement($dom, 'div', 'form-group');
            $form_submit = DOMHelper::createElement($dom, 'input', 'btn btn-theme-primary', null, 'Enroll', ['type' => 'submit']);
